...
sequentialVer:
	gcc ./mergeSortSequential/d2s.c -o BuildMakeFile/mergeSortSequential -std=c90 -pedantic -O2

OpenMpVer:
	gcc ./mergeSortOpenMp/d2omp.c -o BuildMakeFile/mergeSortOpenMp -fopenmp -std=c90 -pedantic -O2

PThreadVer:
	gcc ./mergeSortPThread/d2p.c -o BuildMakeFile/mergeSortPThread -lpthread -std=c90 -pedantic -O2
